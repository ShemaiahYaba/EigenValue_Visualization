...
const ProfileInitials: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div className="absolute right-0 mt-2 z-50 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-xs rounded shadow-lg px-3 py-2 whitespace-nowrap">
